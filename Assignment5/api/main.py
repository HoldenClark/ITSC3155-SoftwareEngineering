...
from .controllers import orders, order_details, resources, recipes, sandwiches
...
@app.get("/orders_details/", response_model=list[schemas.OrderDetail], tags=["OrderDetails"])
